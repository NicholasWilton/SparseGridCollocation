...
To verify that the new code base matches the functionality of the original MatLab code.

1-Asset European Call
...
MuSiK-c
MuSiKc.m
SparseGridCollocationCpp.sln
SparseGridCollocation.sln
