function     [ lamb, TX , C, A, U ]= shapelambda2D_8( coef, inx1, inx2, N, lamb5, TX5, C5, A5,...
...
P=FAI_t - FAI_xx;
    ...
    U=U - PDE( TX,lamb5, TX5, C5, A5, lamb5_4, TX5_4, C5_4, A5_4 )-...
        ...
        PDE( TX, lamb12, TX12, C12, A12, lamb12_11, TX12_11, C12_11, A12_11 );
...
for i=1:Num
    ...
    if (TX(i,1)-inx1(1,1))*(TX(i,2)-inx1(1,2))*(TX(i,2)-inx2(1,2)) == 0
        ...
        U(i)=boundcondition(TX(i,:))-...
            ...
            (inner_test(TX(i,:),lamb11,TX11,C11,A11)-inner_test(TX(i,:),lamb11_10,TX11_10,C11_10,A11_10))-...
            (inner_test(TX(i,:),lamb12,TX12,C12,A12)-inner_test(TX(i,:),lamb12_11,TX12_11,C12_11,A12_11));  % boundary condition
    end
