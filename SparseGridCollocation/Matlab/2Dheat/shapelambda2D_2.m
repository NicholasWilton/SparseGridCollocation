function     [ lamb, TX , C, A, U ]=shapelambda2D_2( coef, inx1, inx2, N, lamb5, TX5, C5, A5,...
...
for i=1:Num
    ...
    if (TX(i,1)-inx1(1,1))*(TX(i,2)-inx1(1,2))*(TX(i,2)-inx2(1,2))  == 0
        ...
        U(i)=boundcondition(TX(i,:))-...
            ...
            (inner_test(TX(i,:),lamb6,TX6,C6,A6)-inner_test(TX(i,:),lamb6_5,TX6_5,C6_5,A6_5));  % boundary condition
    end
