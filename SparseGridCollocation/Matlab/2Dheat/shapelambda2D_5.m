function     [ lamb, TX , C, A, U ]= shapelambda2D_5( coef, inx1, inx2, N, lamb5, TX5, C5, A5,...
...
for i=1:Num
    ...
    if (TX(i,1)-inx1(1,1))*(TX(i,2)-inx1(1,2))*(TX(i,2)-inx2(1,2)) == 0
        ...
        U(i)=boundcondition(TX(i,:))-...
            ...
            (inner_test(TX(i,:),lamb9,TX9,C9,A9)-inner_test(TX(i,:),lamb9_8,TX9_8,C9_8,A9_8));  % boundary condition
    end
