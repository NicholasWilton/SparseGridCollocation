function     [ lamb, TXY , C, A, U ]=shapelambda2D_3( coef, inx1, inx2, N, lamb5, TX5, C5, A5,...
...
for i=1:Num
    ...
    if (TXY(i,1)-inx1(1,1))*(TXY(i,2)-inx1(1,2))*(TXY(i,2)-inx2(1,2))*(TXY(i,3)-inx1(1,3))*(TXY(i,3)-inx2(1,3)) == 0
        ...
        U(i)=boundcondition(TXY(i,:))-...
            ...
            (inner_test(TXY(i,:),lamb7,TX7,C7,A7)-2*inner_test(TXY(i,:),lamb7_6,TX7_6,C7_6,A7_6)+inner_test(TXY(i,:),lamb7_5,TX7_5,C7_5,A7_5));  % boundary condition
    end
