function     [ lamb, TXY , C, A, U ]=shapelambda2D_2( coef, inx1, inx2, N, lamb5, TX5, C5, A5,...
...
for i=1:Num
    ...
    if (TXY(i,1)-inx1(1,1))*(TXY(i,2)-inx1(1,2))*(TXY(i,2)-inx2(1,2))*(TXY(i,3)-inx1(1,3))*(TXY(i,3)-inx2(1,3)) == 0
        ...
        U(i)=boundcondition(TXY(i,:))-...
            ...
            (inner_test(TXY(i,:),lamb6,TX6,C6,A6)-2*inner_test(TXY(i,:),lamb6_5,TX6_5,C6_5,A6_5)+inner_test(TXY(i,:),lamb6_4,TX6_4,C6_4,A6_4));  % boundary condition
    end
