function     [ lamb, TXY , C, A, U ]= shapelambda2D_6( coef, inx1, inx2, N, lamb5, TX5, C5, A5,...
...
for i=1:Num
    ...
    if (TXY(i,1)-inx1(1,1))*(TXY(i,2)-inx1(1,2))*(TXY(i,2)-inx2(1,2))*(TXY(i,3)-inx1(1,3))*(TXY(i,3)-inx2(1,3)) == 0
        ...
        U(i)=boundcondition(TXY(i,:))-...
            ...
            (inner_test(TXY(i,:),lamb10,TX10,C10,A10)-2*inner_test(TXY(i,:),lamb10_9,TX10_9,C10_9,A10_9)+inner_test(TXY(i,:),lamb10_8,TX10_8,C10_8,A10_8));  % boundary condition
    end
