function     [ lamb, TXY , C, A, U ]= shapelambda2D_5( coef, inx1, inx2, N, lamb5, TX5, C5, A5,...
...
for i=1:Num
    ...
    if (TXY(i,1)-inx1(1,1))*(TXY(i,2)-inx1(1,2))*(TXY(i,2)-inx2(1,2))*(TXY(i,3)-inx1(1,3))*(TXY(i,3)-inx2(1,3)) == 0
        ...
        U(i)=boundcondition(TXY(i,:))-...
            ...
            (inner_test(TXY(i,:),lamb9,TX9,C9,A9)-2*inner_test(TXY(i,:),lamb9_8,TX9_8,C9_8,A9_8)+inner_test(TXY(i,:),lamb9_7,TX9_7,C9_7,A9_7));  % boundary condition
    end
