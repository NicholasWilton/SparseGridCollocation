function     [ lamb, TX , C, A, U ]=shapelambda2D_4(coef, tsec,r,sigma,T,E,inx1,inx2,N,lamb2, TX2, C2, A2,lamb3, TX3, C3, A3,...
...
for i=1:Num
    ...
    if TX(i,2) == inx1 || TX(i,2) == inx2
        ...
        U(i)=max( 0, TX(i,2) - E*exp( -r * ( T - TX(i,1) ) ) )-...
            ...
            (inner_test(TX(i,1),TX(i,2),lamb6,TX6,C6,A6)-inner_test(TX(i,1),TX(i,2),lamb_5,TX_5,C_5,A_5));  % boundary condition
