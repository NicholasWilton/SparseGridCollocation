function     [ lamb, TX , C, A, U ]=shapelambda2D_11(coef, tsec,r,sigma,T,E,inx1,inx2,N,lamb2, TX2, C2, A2,lamb3, TX3, C3, A3,...
    ...
    lamb_11, TX_11, C_11, A_11,lamb12, TX12, C12, A12, lamb_12, TX_12, C_12, A_12,lamb13, TX13, C13, A13)
...
U= U - PDE( TX,r,sigma,lamb2,TX2,C2,A2,lamb3,TX3,C3,A3  ) -...
    ...
    PDE( TX,r,sigma,lamb_10,TX_10,C_10,A_10,lamb11,TX11,C11,A11  )-...
    PDE( TX,r,sigma,lamb_11,TX_11,C_11,A_11,lamb12,TX12,C12,A12  )-...
    PDE( TX,r,sigma,lamb_12,TX_12,C_12,A_12,lamb13,TX13,C13,A13  );
...
for i=1:Num
    ...
    if TX(i,2) == inx1 || TX(i,2) == inx2        
        ...
        U(i)=max( 0, TX(i,2) - E*exp( -r * (T - TX(i,1)) ) )-...
            ...
            (inner_test(TX(i,1),TX(i,2),lamb11,TX11,C11,A11)-inner_test(TX(i,1),TX(i,2),lamb_10,TX_10,C_10,A_10))-...
            (inner_test(TX(i,1),TX(i,2),lamb12,TX12,C12,A12)-inner_test(TX(i,1),TX(i,2),lamb_11,TX_11,C_11,A_11))-...
            (inner_test(TX(i,1),TX(i,2),lamb13,TX13,C13,A13)-inner_test(TX(i,1),TX(i,2),lamb_12,TX_12,C_12,A_12));  % boundary condition
    ...
    if TX(i,1) == tsec
        ...
        U(i) = PPP( TX(i,:) ) - ...
            ...
            (inner_test(TX(i,1),TX(i,2),lamb11,TX11,C11,A11)-inner_test(TX(i,1),TX(i,2),lamb_10,TX_10,C_10,A_10))-...
            (inner_test(TX(i,1),TX(i,2),lamb12,TX12,C12,A12)-inner_test(TX(i,1),TX(i,2),lamb_11,TX_11,C_11,A_11))-...
            (inner_test(TX(i,1),TX(i,2),lamb13,TX13,C13,A13)-inner_test(TX(i,1),TX(i,2),lamb_12,TX_12,C_12,A_12));  
    end
