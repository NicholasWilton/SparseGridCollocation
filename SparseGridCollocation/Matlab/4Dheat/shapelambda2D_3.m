function     [ lamb, TXYZ , C, A, U ]=shapelambda2D_3( coef, inx1, inx2, N, lamb7, TX7, C7, A7,...
...
for i=1:Num
    ...
    if (TXYZ(i,1)-inx1(1,1))*(TXYZ(i,2)-inx1(1,2))*(TXYZ(i,2)-inx2(1,2))*...
        ...
        U(i)=boundcondition(TXYZ(i,:))-...
            ...
            3*inner_test( TXYZ(i,:),lamb9_7,TX9_7,C9_7,A9_7 ) - inner_test( TXYZ(i,:),lamb9_6,TX9_6,C9_6,A9_6 ));  % boundary condition
    end
