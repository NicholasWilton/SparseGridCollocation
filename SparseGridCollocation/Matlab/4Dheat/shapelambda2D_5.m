function     [ lamb, TXYZ , C, A, U ]= shapelambda2D_5( coef, inx1, inx2, N, lamb7, TX7, C7, A7,...
...
U = U - PDE( TXYZ, lamb7, TX7, C7, A7,...
    ...
    PDE( TXYZ, lamb11, TX11, C11, A11, lamb11_10, TX11_10, C11_10, A11_10, lamb11_9, TX11_9, C11_9, A11_9, lamb11_8, TX11_8, C11_8, A11_8 );
...
for i=1:Num
    ...
    if (TXYZ(i,1)-inx1(1,1))*(TXYZ(i,2)-inx1(1,2))*(TXYZ(i,2)-inx2(1,2))*...
        ...
        U(i)=boundcondition(TXYZ(i,:))-...
            ...
            3*inner_test( TXYZ(i,:),lamb10_8,TX10_8,C10_8,A10_8 ) - inner_test( TXYZ(i,:),lamb10_7,TX10_7,C10_7,A10_7 ))-...
            ( inner_test( TXYZ(i,:),lamb11,TX11,C11,A11 ) - 3*inner_test( TXYZ(i,:),lamb11_10,TX11_10,C11_10,A11_10 ) +...
            3*inner_test( TXYZ(i,:),lamb11_9,TX11_9,C11_9,A11_9 ) - inner_test( TXYZ(i,:),lamb11_8,TX11_8,C11_8,A11_8 ));  % boundary condition
    end
