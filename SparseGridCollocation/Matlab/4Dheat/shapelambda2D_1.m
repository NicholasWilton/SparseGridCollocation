function     [ lamb, TXYZ , C, A , U ]=shapelambda2D_1( coef, inx1, inx2, N, lamb7, TX7, C7, A7,...
...
%       re-construct the initial and boundary conditions         
        U(i)=boundcondition(TXYZ(i,:))-...
            ...
            3*inner_test( TXYZ(i,:),lamb7_5,TX7_5,C7_5,A7_5 ) - inner_test( TXYZ(i,:),lamb7_4,TX7_4,C7_4,A7_4 ));  % boundary condition
    end
